...
describe("RecommendationService test suite", () => {
    ...
    it("should create recommendation", async () => {
        ...
        await recommendationService.insert({name: "test", youtubeLink: "www.youtube.com/test"});
    ...
    it("should return error, when trying to create a recommendation that already exists", async () => {
        ...
        const promise = recommendationService.insert({name: "test", youtubeLink: "www.youtube.com/test"});
    ...
    it("should upvote recommendation", async () => {
        ...
        jest.spyOn(recommendationRepository, "find").mockImplementation(():any => {
            return {id: 1, name: "test", youtubeLink: "www.youtube.com/test", score: 0};
        })
    ...
    it("should downvote recommendation", async () => {
        jest.spyOn(recommendationRepository, "updateScore").mockImplementation(():any => {
            return {id: 1, name: "test", youtubeLink: "www.youtube.com/test", score: -6};
        });
        jest.spyOn(recommendationRepository, "find").mockImplementation(():any => {
            return {id: 1, name: "test", youtubeLink: "www.youtube.com/test", score: -5};
        })
    ...
    it("should get recommendation by id", async () => {
        ...
        expect(recommendation).toEqual({id: 1, name: "test", youtubeLink: "www.youtube.com/test", score: 0});
    })
    ...
    it("should get random recommendation, random < 0,7", async () => {
        ...
        jest.spyOn(recommendationRepository, "getAmountByScore").mockImplementation(():any => {
            return [{id: 1, name: "test", youtubeLink: "www.youtube.com/test", score: 20}];
        }
        );
        ...
        expect(recommendation).toEqual({id: 1, name: "test", youtubeLink: "www.youtube.com/test", score: 20});
    })
    ...
    it("should get random recommendation, random > 0,7", async () => {
        ...
        jest.spyOn(recommendationRepository, "getAmountByScore").mockImplementation(():any => {
            return [{id: 1, name: "test", youtubeLink: "www.youtube.com/test", score: 10}];
        }
        );
        ...
        const recommendation = await recommendationService.getRandom();
        expect(recommendation).toEqual({id: 1, name: "test", youtubeLink: "www.youtube.com/test", score: 10});
    })
